    ...
    <div className="mt-14 mb-12">
      <div className="container">
        ...
        <div className="text-center mb-10 max-w-[600px] mx-auto">
          ...
          Step out with confidence and make a statement with the Fashion.
        ...
        <div>
          ...
          <div className="flex justify-center">
            <button className="text-center mt-10 cursor-pointer bg-gradient-to-r from-purple-800 to-pink-600 text-white py-1 px-5 rounded-md">
              View All Button
            </button>
          </div>
        </div>

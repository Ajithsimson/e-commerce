        ...
        <div className="container flex justify-between items-center">
          ...
          <div className="flex justify-between items-center gap-4">
            <div className="relative group hidden sm:block">
              ...
              />
              <IoMdSearch className="text-purple-700 group-hover:text-pink-950 
            ...
            <button
              ...
              className="bg-gradient-to-r from-purple-900 to-pink-700 transition-all
        ...
        <ul className="sm:flex hidden items-center gap-4">
          {Menu.map((data) => (
            <li key={data.id}>
              <a
                href={data.link}
                className="inline-block px-4 hover:text-purple-950 duration-200"
              >
                {data.name}
              </a>
            </li>
              ...
              <ul>
                {DropdownLinks.map((data) => (
                  <li key={data.id}>
                    <a
                      href={data.link}
                      className="inline-block w-full rounded-md p-2 hover:bg-purple-600/20 "
                    >
                      {data.name}
                    </a>
                  </li>
